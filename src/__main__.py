    ...
    *,
    ...
    if effective_duration is None and previous_interaction_id:
        ...
        if effective_duration is not None:
            ...
            duration_source = (
                "unknown: the render could not be measured and the source was "
                "not generated by this server. An edit's length is chosen by "
                "the service, so this figure is the request, not the render"
            )
