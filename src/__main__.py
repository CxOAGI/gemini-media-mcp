...
async def _omni_generate_and_manifest(
    ...
    *,
    ...
    # rendered. Falls back to the inherit-from-source lookup, then to honest
    # uncertainty.
    ...
    if effective_duration is None and previous_interaction_id:
        ...
        if effective_duration is not None:
            duration_source = "inherited from the source video"
        else:
            duration_source = (
                "unknown: this edit inherits the source video's length, the "
                "render could not be measured, and the source was not "
